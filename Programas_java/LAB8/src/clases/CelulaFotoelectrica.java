 ...
 * @author Daniel
 */
public class CelulaFotoelectrica {
    ...
    public void setNombreEstado() {
        if (estado == true) {
            nombreEstado = "DIA";//asigna un nombre a la variable nombreEstado cuando estado es igual a true
        }
        if (estado == false) {
            nombreEstado = "NOCHE";//asigna un nombre a la variables nombre Estado cuando estado es igual a false 
        }
    }
