...
public class SensorDeposito {
    ...
    public void setNombreEstado() {
        if (estado == true) {
            nombreEstado = "DEPOSITO VACIO";//asigna un nombre a la variable nombreEstado cuando estado es igual a true
        }
        if (estado == false) {
            nombreEstado = "DEPOSITO LLENO";//asigna un nombre a la variables nombre Estado cuando estado es igual a false 
        }
    }
